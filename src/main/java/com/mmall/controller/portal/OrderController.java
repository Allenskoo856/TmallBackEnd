...
public class OrderController {
    ...
    @ResponseBody
    public ServerResponse pay(HttpServletRequest httpServletRequest, Long orderNo, HttpServletRequest request) throws IOException {
        String loginToken = CookieUtil.readLoginToken(httpServletRequest);
        if (StringUtils.isEmpty(loginToken)) {
            return ServerResponse.createByErrorMassage("用户未登录,无法获取当前用户的信息");
        }
    ...
    public Object alipayCallback(HttpServletRequest request) {
        ...
        try {
            ...
            if (!alipayRSACheckedV2) {
                return ServerResponse.createByErrorMassage("非法请求,验证不通过,再恶意请求我就报警找网警了");
            }
